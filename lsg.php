...
<body background=background_ipl.jpg>
  <style>
    body {
  background:url('http://m.gettywallpapers.com/wp-content/uploads/2022/07/Baby-Blue-Wallpaper.jpg');
  ...
  <center>
    <h1 style="color:white;" >LSG Previous team</h1>
    <div="container">
      <form action=""method="POST">
          <input type="submit" name="search" placeholder="Search By name"/>
      </form>
      <img src="https://www.indiantelevision.com/sites/default/files/styles/smartcrop_800x800/public/images/tv-images/2022/03/22/img_22032022_170255_800_x_800_pixel.png?itok=_JI76UeN" width="550" height="400" align="left">
      <table>
        <tr>
