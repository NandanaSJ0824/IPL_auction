...
<body background=background_ipl.jpg>
  <style>
    body {
  background:url('https://www.slidebackground.com/thumb/purple-background/plain-purple-backgrounds-wallpaper-cave-19.jpg');
  ...
  <center>
    <h1 style="color:white;" >KKR Previous team</h1>
    <div="container">
      <form action=""method="POST">
          <input type="submit" name="search" placeholder="Search By name"/>
      </form>
      <img src="https://i.pinimg.com/originals/c8/e9/e6/c8e9e65d1d2f9d2472dd64a875c5c238.jpg" width="550" height="600" align="left">
      <table>
        <tr>
