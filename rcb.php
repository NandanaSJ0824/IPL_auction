...
<body background=background_ipl.jpg>
  <style>
    body {
  background:url('https://img.freepik.com/free-vector/royal-watercolor-valentine-red-background_1340-4006.jpg?w=740&t=st=1673602230~exp=1673602830~hmac=5dee7f691c60bd6ec2bb98511706087445fbf3a0ba2a35128b57719141ffd3b1');
  ...
  <center>
    <h1 style="color:white;" >RCB Previous team</h1>
    <div="container">
      <form action=""method="POST">
          <input type="submit" name="search" placeholder="Search By name"/>
      </form>
      <img src="https://i.pinimg.com/originals/54/96/c3/5496c328d02c848b352190a0eee94dc1.jpg" width="350" height="400" align="left">
      <table>
        <tr>
