...
<body background=background_ipl.jpg>
  <style>
    body {
  background:url('https://images.unsplash.com/photo-1629197521865-4946b4acd2b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=825&q=80');
  ...
  <center>
    <h1 style="color:white;" >GT Previous team</h1>
    <div="container">
      <form action=""method="POST">
          <input type="submit" name="search" placeholder="Search By name"/>
      </form>
      <img src="https://imgk.timesnownews.com/story/Gujarat_Titans_logo.png?tr=w-1200,h-900" width="550" height="400" align="left">
      <table>
        <tr>
