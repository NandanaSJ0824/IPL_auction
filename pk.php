...
<body background=background_ipl.jpg>
  <style>
    body {
  background:url('https://wallpaperaccess.com/full/175872.jpg');
  ...
  <center>
    <h1 style="color:white;" >PK Previous team</h1>
    <div="container">
      <form action=""method="POST">
          <input type="submit" name="search" placeholder="Search By name"/>
      </form>
      <img src="https://i.pinimg.com/originals/21/ea/e4/21eae462a547a8aa416788e0f63c82e9.png" width="450" height="400" align="left">
      <table>
        <tr>
